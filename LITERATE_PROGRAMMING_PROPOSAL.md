# Proposal: Synchronous Literate Programming (SLP) for Dev-Centr
...
Instead of treat narrative and code as separate entities, they are sibling nodes in a single tree.
