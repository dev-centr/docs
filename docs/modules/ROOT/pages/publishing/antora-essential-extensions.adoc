...
*Companion UI:* copy `ui/partials/nav-tree.hbs`, `ui/helpers/*.js`, `ui/css/nav-typology.css`, and `ui/img/nav-typology.svg` from the package into hub `supplemental-ui/` (same pattern as site-nav-tree `nav-menu.hbs`).
