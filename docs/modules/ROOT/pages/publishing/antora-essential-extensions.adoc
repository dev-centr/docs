...
*Upstream note for `@antora-supplemental/site-nav-tree`:* document this multi-nav concatenation behavior in the extension README (DevCentr hub carries the diagram until upstream merges).
