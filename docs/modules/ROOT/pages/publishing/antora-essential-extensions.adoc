...
*Playbook:* See xref:publishing/antora-diagram-formats.adoc[Antora diagram formats]. Compose with Lunr/math/Valentus via link:https://github.com/antora-supplemental/facto-stack[`facto-stack`] — not by loading extras into Valentus core.
...
Registered in link:https://github.com/antora-supplemental/facto-stack[facto-stack] by default.
