...
Hub companion JS (`supplemental-ui/js/site-nav-tree-current.js`) prefers the deepest `is-current-page`, expands only that ancestry (`is-current-path`), and restores other open trees from `sessionStorage` across navigations. In-doc link crossfade + scroll preservation: `supplemental-ui/js/site-doc-nav.js`. Wide AsciiDoc tables: `supplemental-ui/js/adt-table-scroll.js` (see xref:publishing/antora-ui-branding.adoc#wide-asciidoc-tables[wide table scroll]).
...
=== Build stack footer (`@antora-supplemental/build-stack`)

*Package:* link:https://github.com/antora-supplemental/build-stack[`@antora-supplemental/build-stack`]
...
Registered in link:https://github.com/antora-supplemental/antora-facto[antora-facto] by default.
